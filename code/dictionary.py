...
class Dictionary:
    ...
    def init(self):
        ...
        with open('inverted_index_500.pickle', 'rb') as inverted_index:
        ...
        # TODO: SAVING DOC2VECS
        # with open('doc2term_index_500.pickle', 'rb') as doc2term:
        #     doc2term_index = pickle.load(doc2term)
        #
        # print(len(doc2term_index))
        # self.doc_set = doc2term_index
        # term2key = list(self.dictionary.keys())
        # for key in doc2term_index.keys():
        ...
        #
        # with open('doc2vec_2000.pickle', 'wb') as handle:
        #     pickle.dump(self.doc2vec, handle, protocol=pickle.HIGHEST_PROTOCOL)

        # TODO: LOADING DOC2VECS
        with open('doc2vec_2000.pickle', 'rb') as doc2vec:
